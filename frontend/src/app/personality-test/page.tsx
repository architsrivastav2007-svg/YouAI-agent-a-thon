    ...
    const interval = setInterval(() => {
      setCountdown((prev) => {
        if (!prev || prev <= 1) {
          ...
          return 0; // Set to 0 instead of null to trigger navigation
        }
        return prev - 1;
      });
    }, 1000);
          ...
          <Card className="bg-white/20 backdrop-blur-md shadow-xl rounded-2xl p-6 border-none">
            ...
            <CardContent className="mt-6 space-y-4 flex flex-col items-center">
              <div className="text-sm text-white/70 italic">
                Your personality data will be used to personalize your YouAI
                experience.
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-medium transition-all whitespace-nowrap font-sora cursor-pointer"
                >
                  Initializing YouAI Twin
                </button>
                {/* </a> */}
              </div>
